...
public class ComponentLineMarkerTest extends LineMarkerTestCase {
    ...
    public void testPrimaryElementLineMarkerExtends() throws Exception {
        myFixture.configureByFiles("PrimaryElementLineMarkerParent.xml", getTestName(false) + ".xml");
    ...
    public void testPrimaryElementLineMarkerBoth() throws Exception {
        myFixture.configureByFiles("PrimaryElementLineMarkerParent.xml", "PrimaryElementLineMarkerExtends.xml", "PrimaryElementLineMarkerModifies.xml");
        doTest(
